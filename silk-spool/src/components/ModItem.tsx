...
export const ModItem: React.FC<ModItemProps> = ({ mod, isSelected, onClick }) => {
  ...
  return (
    ...
    >
      ...
      <div className='flex items-start justify-between mb-2'>
        ...
        <span
          className={`text-xs px-2 py-1 rounded-full ${
            isSelected ? 'bg-primary-500 text-white' : 'bg-gray-700 text-gray-300'
          }`}
        >
      ...
      {/* Description */}
      <p className={`text-xs mb-3 line-clamp-2 ${isSelected ? 'text-gray-200' : 'text-gray-300'}`}>
        {mod.description}
      </p>
